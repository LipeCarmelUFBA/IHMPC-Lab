...
qu = [10, 10, 0]          # input target weights
su = [1e4, 1e4, 0]        # input slacks
...
ymax = [[0, 0, 0], [52-yss[0], 53-yss[1], 90-yss[2]], [52-yss[0], 53-yss[1], 90-yss[2]], [49-yss[0], 53-yss[1], 90-yss[2]]]
ymin = [[0, 0, 0], [45-yss[0], 52-yss[1], 70-yss[2]], [45-yss[0], 52-yss[1], 70-yss[2]], [45-yss[0], 52-yss[1], 70-yss[2]]]
utarget = [[0, 0, 0], [0.2, -100, 0.0], [-0.2, -100, 0.0], [-0.2, -100, 0.0]]
ysp_change = [5, 100, 150]
tf = 200

closedloop.configPlot.folder = '../../../../results'
closedloop.configPlot.subfolder = 'Integrating - Distillation Column - Provided Targets'
