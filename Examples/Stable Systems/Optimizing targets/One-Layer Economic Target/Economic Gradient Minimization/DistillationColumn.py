...
controller = IHMPC(controllermodel, m, qy, r, sy=sy, si=1e3, zone=1, optimizer='cvxopt')

# Defining the quadratic economic objective
fss = 0                            # Economic objective at steady state
dfdy = array([0, 0], ndmin=2)
dfdu = array([1, 0], ndmin=2)      # Minimum steam feed, leading to reduced temperature
P = [1e-1 for ele in range(0, controller.nu)]
...
esp = [-1, -1, -1, -1]  # The target lies outside of input constraints

ysp_change = [10, 600, 800]
tf = 850

closedloop.configPlot.folder = '../../../../../results'
closedloop.configPlot.subfolder = 'Stable - Distillation Column - Economic Gradient Minimization'
